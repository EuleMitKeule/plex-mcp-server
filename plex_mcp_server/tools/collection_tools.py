"""
Collection-related tools for Plex Media Server.
Provides tools to manage Plex collections.
"""
...
class PlexCollectionTools(PlexMcpTools):
    """Tools for managing Plex collections."""
    ...
    def __init__(
        ...
        """Initialize the Plex Collection Tools."""
    ...
    async def collection_list(self, library_name: Optional[str] = None) -> str:
    ...
    async def collection_create(
        ...
        try:
            ...
            if not items:
                return json.dumps(
                    {"error": "No matching media items found for the collection"},
                    indent=4,
                )
        ...
        try:
            ...
            if collection_id:
                try:
                    ...
                    return json.dumps(
                        {"error": f"Error fetching collection by ID: {str(e)}"},
                        indent=4,
                    )
            else:
                ...
                matching_collections = [
                    ...
                    and c.title.lower() == collection_title.lower()
                ]
